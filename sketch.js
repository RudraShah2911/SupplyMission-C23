...
function setup() {
	...
	box2 = createSprite (510,610,20,100,{isStatic : true})
	box2.shapeColor = ("red")

	box3 = createSprite (290,610,20,100,{isStatic : true})
	box3.shapeColor = ("red")
	...
	//Create a Ground
	ground = Bodies.rectangle(width/2, 650, width, 55 , {isStatic:true} );
